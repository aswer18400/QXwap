/*
 * QXwap Figma MCP Real Components + Variants Generator
 *
 * Use with Figma MCP `use_figma` after quota is available.
 * Run variables first: docs/figma-console/s0-variables.js or Tokens Studio import.
 *
 * Target file: 3BHvaNXqmDQJsqpfanxtHL
 * Required use_figma options: fileKey, skillNames: "figma-use"
 *
 * Creates real Figma components/component sets with Auto Layout and binds:
 * - color variables for fills/strokes/text fills
 * - key FLOAT variables for spacing, radius, padding, and button height
 * - QXwap/Icon variants from docs/figma-free-import-kit/icon-registry.json
 */
