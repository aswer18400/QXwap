...
(async function qxwapAllInOne() {
  ...
  var result2 = await (async function() {
    ...
    title.appendChild(text("Generated by docs/figma-console/qxwap-all-in-one.js. Components use Auto Layout and bind variables when matching Figma Variables exist.", 14, false, C.muted, "muted"));
