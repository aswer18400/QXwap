/*
 * QXwap Figma MCP Component Screens Rebuilder
 *
 * Step 4:
 * - Archive raw HTML capture frames/pages
 * - Rebuild 8 core mobile screens using real component instances from Step 3
 * - Use Auto Layout throughout
 * - Preserve Dev Mode inspectability: component names + token-bound styles
 *
 * Use with Figma MCP `use_figma` after:
 * 1. tokens.json has been imported/pushed as Figma Variables
 * 2. figma-mcp-styles-script.js has run
 * 3. figma-mcp-real-components-script.js has run
 *
 * Target file:
